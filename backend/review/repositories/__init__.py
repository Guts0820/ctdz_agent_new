...
from review.domain.enums import AnalysisStatus, Difficulty, ItemStatus, PlanMode, PlanStatus
from review.integrations.neo4j_contracts import Neo4jKnowledgeGraphClient
from review.schemas.priority import KnowledgeStateInput, PriorityRunResponse
...
REVIEW_DATABASE = "backend/database/example_db.db"
...
class Neo4jRepository:
    ...
    def _query_answer_history(self, student_id: str) -> list[dict]:
        ...
        if missing:
            try:
                ...
                from database_neo4j import neo4j_conn as neo4j_client
                for qid in missing:
    ...
    def _get_fallback_states(self, student_id: str) -> list[KnowledgeStateInput]:
        ...
        from review.schemas.priority import KnowledgeStateInput
        return [
            KnowledgeStateInput(
                student_id=student_id,
