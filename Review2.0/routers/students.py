...
def get_students(
    ...
    query += " RETURN s.student_id as id, s.name as name, s.grade as grade, s.class_name as class_name, s.gender as gender, s.school as school ORDER BY s.student_id"
...
def get_class_students(class_name: str):
    try:
        results = neo4j_conn.query("""
            ...
            RETURN s.student_id as id, s.name as name, s.grade as grade,
